...
public class JCrypt {
    ...
    /**
     * Encrypts the provided plaintext password using the UNIX password
     * hashing algorithm.  This is an equivalent function to the Perl crypt()
     * function used by some web applications (Bugzilla, etc).
     *
